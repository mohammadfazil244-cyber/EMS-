...
function Myattendence() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://ems-backend-6-q03r.onrender.com/Employee/myattendence/${startDate}/${endDate}/${email}`,
        {
          headers: {
  ...
  return (
    <div className="myattendance-container">
      <h1 className="myattendance-title">My Attendance</h1>
      ...
      <div className="date-filter">
        ...
        <input
          ...
          onChange={(e) => setSecondDate(new Date(e.target.value))}
        />
